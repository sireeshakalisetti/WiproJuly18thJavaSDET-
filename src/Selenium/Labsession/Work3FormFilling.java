...
import com.wiprojuly.testng.TestngListners;

import io.github.bonigarcia.wdm.WebDriverManager;
@Listeners(TestngListners1.class)
public class Work3FormFilling {
	...
	public  void formFilling() throws InterruptedException {
		...
		firstname.sendKeys("Kalisetti");
		WebElement lastname = driver.findElement(By.xpath("//input[@name='lastname']"));
		lastname.sendKeys("Hema Sai Sireesha");
